    ...
    <div style={styles.page}>
      ...
      <div style={styles.card}>
        ...
        <form onSubmit={onSubmit} style={{ display: 'grid', gap: 12 }}>
          <input placeholder={t('tenantCode')} value={tenantCode} onChange={(e) => setTenantCode(e.target.value)} style={styles.input} />
          <input placeholder={t('email')} value={email} onChange={(e) => setEmail(e.target.value)} style={styles.input} />
          <input placeholder={t('password')} type="password" value={password} onChange={(e) => setPassword(e.target.value)} style={styles.input} />
...
const styles = {
  ...
  card: { maxWidth: 420, margin: '80px auto 0', background: '#111218', border: '1px solid #2a2b33', borderRadius: 18, padding: 18 },
  input: { width: '100%', padding: '12px 12px', borderRadius: 12, border: '1px solid #2a2b33', background: '#050507', color: '#F5F5F5', outline: 'none' },
  primary: { padding: '12px 18px', borderRadius: 999, background: '#F5C76A', color: '#111', border: 'none', fontWeight: 900, cursor: 'pointer', marginTop: 6 },
  err: { background: '#2a1212', border: '1px solid #ff4d4d66', color: '#ffb3b3', padding: 10, borderRadius: 12, marginBottom: 12, fontSize: 13 },
};
